  ...
  //note that de will be deleted after being entered.
{
    ...
    entries[num_entries] =*de;//error here£¬type not changed
	//entries[num_entries].type=(*de).type;
...
void RTNode::rangeQuery(float * mbr, SortedLinList * res, long type)
{
	int i, n;
	SECTION s;
	RTNode *succ;
