...
// check wether mbr1 falls inside mbr2
bool g_mbr_inside(float* pMbr1, float *pMbr2, int MbrDimen)
{
	for (int i = 0; i < MbrDimen; i++)
	{
		if ((pMbr1[2 * i] < pMbr2[2 * i]) || (pMbr1[2 * i + 1] > pMbr2[2 * i + 1]))
		{
			return FALSE;
		}
	}
